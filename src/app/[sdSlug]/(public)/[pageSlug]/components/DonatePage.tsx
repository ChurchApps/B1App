    ...
    <Container>
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ md: 4, xs: 12 }}>
          ...
          <a href="https://support.churchapps.org/b1-church/giving/making-donations" target="_blank" rel="noopener noreferrer" style={{ textDecoration: "underline", textUnderlineOffset: 2, display: "flex", justifyContent: "center", alignItems: "center", fontSize: "15px" }} data-testid="donate-instructions-link">
          ...
          <Link href="/mobile/login?returnUrl=/mobile/donate">
