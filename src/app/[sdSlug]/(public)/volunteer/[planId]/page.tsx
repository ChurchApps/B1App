...
export async function generateMetadata({ params }: { params: PageParams }): Promise<Metadata> {
  ...
  const title = planData ? Locale.label("volunteer.volunteer") + " - " + planData.plan.name : Locale.label("volunteer.volunteer");
  return MetaHelper.getMetaData(title + " - " + config.church.name, Locale.label("volunteer.metaPlanDescription"), undefined, config.appearance);
}
