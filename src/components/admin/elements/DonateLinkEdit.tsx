  ...
  return (
    <>
      ...
      <TextField
        ...
        size="small"
        placeholder="/donate"
        helperText="Tip: you must link the page from the website builder that has the donation element."
        label="Url"
        name="url"
      ...
      <TextField
        fullWidth
        size="small"
        helperText="Ex: (Donate now), (Yes, I will help!), (Donate $10 to Youth Camp), etc.."
        label="Text"
        name="text"
