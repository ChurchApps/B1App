...
import { GenericSettingInterface, ArrayHelper } from "@/helpers";

//This is used by the logo editor.  We need to eliminate it and use the copy from appBase instead.
interface Props {
...
export const TempImageEditor: React.FC<Props> = (props) => {
