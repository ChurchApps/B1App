              ...
              <Stack spacing={1}>
                {fontList.map(body => (
                  ...
                  >
                    ...
                    >
                      {heading} heading with {body} body
                    </Typography>
                  </Box>
                ))}
              </Stack>
  ...
  return (
    <Box sx={{ maxWidth: 1200 }}>
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Box>
              ...
              <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.9)' }}>
                Select and customize your site's fonts
              </Typography>
            </Box>
          </Stack>
      ...
      <Box sx={{ p: 3, backgroundColor: '#FFF', borderRadius: '0 0 12px 12px', border: '1px solid', borderColor: 'grey.200', borderTop: 'none' }}>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          >
            <Box sx={{ p: 3, backgroundColor: alpha('#f5f5f5', 0.3), borderRadius: 2 }}>
              ...
              >
                Faucibus purus in massa tempor. Venenatis lectus magna fringilla urna porttitor rhoncus dolor purus non. Accumsan tortor posuere ac ut. Sit amet facilisis magna etiam.
              </Typography>
            </Box>
          </CardWithHeader>
        </Box>
        ...
        <Box sx={{ mt: 3 }}>
          <CardWithHeader
            title="Popular Font Combinations"
            icon={<StyleIcon />}
          >
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Click any combination to apply it instantly
            </Typography>
            {getPairings()}
          </CardWithHeader>
        </Box>
