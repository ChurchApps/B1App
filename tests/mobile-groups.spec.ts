...
// /locale-sync, so Locale.label() returned the key itself. The mobile Edit event dialog
// rendered its reminder toggle as "mobile.group.reminders.enable".
test.describe.serial("Mobile group event reminders", () => {
  const GROUP_ID = "GRP00000023";
